...
**DClaw Video** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8067` (FastAPI)
- **Frontend Port:** `3067` (Next.js)
- **Database:** `dclaw_video` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3067`
